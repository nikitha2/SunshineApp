...
public final class NetworkUtils {
   ...
   // private static final String DYNAMIC_WEATHER_URL ="https://andfun-weather.udacity.com/weather";
    private static final String DYNAMIC_WEATHER_URL ="https://community-open-weather-map.p.rapidapi.com/forecast?";
     ...
     * @return The Url to use to query the weather server.
     */
    public static URL buildUrl(Double lat, Double lon) throws MalformedURLException {
        Uri  buildUri=Uri.parse(DYNAMIC_WEATHER_URL).buildUpon().
                appendQueryParameter(CALLBACK,"JSONP").
                appendQueryParameter(LAT_PARAM, String.valueOf(lat)).
                appendQueryParameter(LON_PARAM, String.valueOf(lon)).
                appendQueryParameter(UNITS_PARAM,"metric or imperial").build();
